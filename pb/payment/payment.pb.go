...
func (x *CreatePaymentRequest) GetPaymentMethod() int64 {
	if x != nil {
...
const file_payment_payment_proto_rawDesc = "" +
	"\n" +
	"\x15payment/payment.proto\"\x92\x01\n" +
	"\x14CreatePaymentRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x19\n" +
	"\border_id\x18\x02 \x01(\x03R\aorderId\x12\x1f\n" +
	"\vtotal_price\x18\x03 \x01(\x02R\n" +
	"totalPrice\x12%\n" +
	"\x0epayment_method\x18\x04 \x01(\x03R\rpaymentMethod\"O\n" +
	"\x15CreatePaymentResponse\x12\x1d\n" +
	"\n" +
	"payment_id\x18\x01 \x01(\x03R\tpaymentId\x12\x17\n" +
	"\abill_id\x18\x02 \x01(\x03R\x06billId2B\n" +
	"\aPayment\x127\n" +
	"\x06Create\x12\x15.CreatePaymentRequest\x1a\x16.CreatePaymentResponseB9Z7github.com/dangthanhduong01/microservices_proto/paymentb\x06proto3"
